...
2. **Доработайте [диаграмму контейнеров PropDevelopment](./template_C4_container_model.drawio.xml).** Отразите на ней изменения, которые вы предлагаете сделать в ландшафте систем компании в связи с внедрением новых бизнес-функций.
